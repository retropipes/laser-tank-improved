 ...
 */
package com.puttysoftware.lasertank.improved.integration;
...
public class NativeIntegration {
	...
	if (this.supported) {
	    if (this.desktop.isSupported(Desktop.Action.APP_EVENT_SCREEN_SLEEP)) {
		this.desktop.addAppEventListener(listener);
	    }
	}
    }
	...
	if (this.supported) {
	    if (this.desktop.isSupported(Desktop.Action.APP_EVENT_SYSTEM_SLEEP)) {
		this.desktop.addAppEventListener(listener);
	    }
	}
    }
	...
	if (this.supported) {
	    if (this.desktop.isSupported(Desktop.Action.APP_EVENT_USER_SESSION)) {
		this.desktop.addAppEventListener(listener);
	    }
	}
    }
	...
	if (this.supported) {
	    if (this.desktop.isSupported(Desktop.Action.APP_SUDDEN_TERMINATION)) {
	...
	if (this.supported) {
	    if (this.desktop.isSupported(Desktop.Action.APP_REQUEST_FOREGROUND)) {
