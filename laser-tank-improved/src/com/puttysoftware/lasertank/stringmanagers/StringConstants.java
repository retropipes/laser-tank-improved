...
public class StringConstants {
    ...
    public static final int STRINGS_FILE_DIFFICULTY = 0;
    public static final int STRINGS_FILE_ERROR = 1;
    public static final int STRINGS_FILE_PREFS = 2;
    public static final int STRINGS_FILE_GENERIC = 3;
    public static final int STRINGS_FILE_OBJECT = 4;
    public static final int STRINGS_FILE_MENU = 5;
    public static final int STRINGS_FILE_DIALOG = 6;
    public static final int STRINGS_FILE_MESSAGE = 7;
    public static final int STRINGS_FILE_EDITOR = 8;
    public static final int STRINGS_FILE_GAME = 9;
    public static final int STRINGS_FILE_ERA = 10;
    static final int STRINGS_FILE_LANGUAGE = 0;
    public static final int STRINGS_FILE_GLOBAL = -1;
    public static final int STRINGS_FILE_IMAGE = -2;
    public static final int STRINGS_FILE_FRAME = -3;
    public static final int STRINGS_FILE_DIRECTION = -4;
    public static final int STRINGS_FILE_INDEX = -5;
