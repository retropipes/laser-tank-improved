...
public class ToughBricks extends AbstractReactionWall {
    // Constructors
    public ToughBricks() {
	super();
	...
	LTRemix.getApplication().getGameManager().morph(new Bricks(), locX, locY, locZ, this.getPrimaryLayer());
	...
	SoundManager.playSound(SoundConstants.SOUND_BREAK_BRICKS);
	LTRemix.getApplication().getGameManager().morph(new Bricks(), locX + dirX, locY + dirY, locZ,
