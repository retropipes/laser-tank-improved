 ...
 * later usage. Created by Tommy Ettinger on 5/1/2016.
 *
 * @author Tommy Ettinger
 * @see NaturalLanguageCipher NaturalLanguageCipher offers similar features but
...
public class LanguageCipher implements Serializable {
     ...
     */
    public LanguageCipher(final FakeLanguageGen language) {
	this(language, 0);
    }
     ...
     */
    public LanguageCipher(final FakeLanguageGen language, final long shift) {
	this.shift = shift;
     ...
     */
    public LanguageCipher(final LanguageCipher other) {
	...
	if (this.table.containsKey(s2)) {
	    ...
	    final long h = CrossHash.hash64(s2) + this.shift;
	    long frustration = 0;
	    this.rng.setState(h);
	    do {
		ciphered = this.language.word(this.rng, false,
			(int) Math.ceil(s2.length() / (2.2 + this.rng.nextDouble())));
     ...
     */
    public String cipher(final CharSequence text) {
	final Replacer rep = LanguageCipher.wordMatch.replacer(new CipherSubstitution());
	...
	public void appendSubstitution(final MatchResult match, final TextBuffer dest) {
	    dest.append(LanguageCipher.this.lookup(match.group(0)));
	}
    }
     ...
     */
    public LanguageCipher learnTranslation(final Map<String, String> vocabulary, final String sourceWord) {
     ...
     * @return this, for chaining
     */
    public LanguageCipher learnTranslations(final Map<String, String> vocabulary, final String... sourceWords) {
     ...
     * @return this, for chaining
     */
    public LanguageCipher learnTranslations(final Map<String, String> vocabulary, final Iterable<String> sourceWords) {
     ...
     * @return this, for chaining
     */
    public LanguageCipher mismatchTranslation(final Map<String, String> vocabulary, final String correctWord,
