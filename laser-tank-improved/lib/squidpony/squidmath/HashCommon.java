...
/**
 * Code used internally for hashing OrderedMap, OrderedSet, IntDoubleOrderedMap,
 * Arrangement, and so on. Has some methods and constants that may be useful in
 * other kinds of code. Created by Tommy Ettinger on 7/28/2017.
 */
public class HashCommon {
	...
	return (x ^ x >>> 16) * HashCommon.INV_INT_PHI;
    }

    /**
     * Quickly mixes the bits of a long integer. <br>
     * This method mixes the bits of the argument by multiplying by the golden ratio
	...
	x ^= x >>> 32;
	x ^= x >>> 16;
	return (x ^ x >>> 32) * HashCommon.INV_LONG_PHI;
    }
