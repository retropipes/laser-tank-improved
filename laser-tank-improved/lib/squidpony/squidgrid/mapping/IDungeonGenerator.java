...
public interface IDungeonGenerator {
     ...
     * but each must provide this as a sane default. Most implementations should use
     * the convention of '#' representing a wall and '.' representing a bare floor,
     * but beyond that, anything could be present in the char array.
     *
     * @return a 2D char array representing some kind of map, probably using
     *         standard conventions for walls/floors
     */
    char[][] generate();
