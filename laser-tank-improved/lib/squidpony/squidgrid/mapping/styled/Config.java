...
public class Config {
    ...
    // public int num_color_0, num_color_1, num_color_2, num_color_3, num_color_4 =
    // 0, num_color_5 = 0;
    ...
    public Config() {
	this.is_corner = true;
	this.num_colors = new int[] { 1, 1, 1, 1 };
	/*
	 * num_color_0 = 1; num_color_1 = 1; num_color_2 = 1; num_color_3 = 1;
	 */
	this.num_x_variants = 1;
	this.num_y_variants = 1;
    }
}
