...
/**
 * An enumeration of all the kinds of dungeon that DungeonBoneGen knows how to
 * draw already. Each value has a Javadoc description. Created by Tommy Ettinger
 * on 3/10/2015.
 */
public enum TilesetType {
    /**
     * A generally useful kind of dungeon for ruins or underground manufactured
     * areas. <br>
     * Example: <br>
     *
     * <pre>
    ...
    DEFAULT_DUNGEON,
    /**
     * A good general kind of cave, with long distances between merging paths. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
     ...
     * <br>
     * Example (made with DungeonGenerator, which only keeps one contiguous area,
     * but doesn't use Chebyshev distance to determine what areas are contiguous):
     * <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * Most parts of the cave are large and open, but tiny corridors link them,
     * providing hiding places. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * Slightly less basic demo dungeon. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * A bit more complexity in this demo dungeon. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * A reference implementation of where you can place walls; mostly floor. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * A reference implementation of where you can place walls; mostly wall. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * A generally good maze; MAZE_A and MAZE_B should both be interchangeable, but
     * not on the same map. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    MAZE_B,
    /**
     * A map that's less dungeon-like than the others, with lots of open space. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    OPEN_AREAS,
    /**
     * An excellent natural cave style that looks worn down haphazardly, as by
     * burrowing creatures or deep rivers. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * Mostly open, but with long corridors that should be a good fit for ranged
     * combat. <br>
     * Example: <br>
     *
     * <pre>
    ...
    /**
     * A thing of beauty. Good for maps that need to seem otherworldly or unusual,
     * like heavenly planes. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * A more open cave, but portions of this may seem artificial. Consider
     * alternating with REFERENCE_CAVES . <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    SIMPLE_CAVES,
    /**
     * Kinda... not the best map. Very predictable. <br>
     * Example: <br>
     *
     * <pre>
     * ############################################################
    ...
    /**
     * Returns MixedGenerator.CAVE_FLOOR (which is 3) or MixedGenerator.ROOM_FLOOR
     * (which is 1) based on whether this TilesetType predominantly generates caves
     * or rooms. This is relevant for certain feature placement.
     *
     * @return 3 if this produces mostly caves, or 1 if it produces mostly rooms
     */
    public int environment() {
	final int caves = 3, rooms = 1;
	switch (this) {
	case CAVES_LIMIT_CONNECTIVITY:
	    return caves;
	case CAVES_TINY_CORRIDORS:
